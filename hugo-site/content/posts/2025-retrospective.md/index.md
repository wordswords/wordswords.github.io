...
- In December, I realised that I needed to have a more formal qualification in AI/ML/GenAI because it is becoming so 'key' to modern technology. I signed up for a 7-month professional certificate in AI/ML at [Imperial College London](https://www.imperial.ac.uk/), again distance learning, that I will study alongside my masters degree and the other upskilling I am doing.
...
- Additionally, we have now moved in fully to the new place, and we have a whole new set of [IKEA](https://www.ikea.co.uk) furniture installed thanks to Conny's flat-pack skills, and a full network cabinet, and a gigabit broadband connection, and all the things you miss while technically 'homeless' and bouncing around AirBnBs.
- I have upgraded and repaired [my e-bike setup](https://davidcraddock.net/my-bike), so now it is much more of what I envisaged as a 'car replacement' and I use it heavily for exercise and just general errands.
...
- I have had to put the Retro Gaming Meetups that I organise on hold while we have been moving, but I hope to start the meetings up again in the new year. We have a possibility of hosting them in a dedicated space which is very exciting, more on that to be revealed later.
