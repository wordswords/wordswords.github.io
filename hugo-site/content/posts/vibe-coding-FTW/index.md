...
My coding environment is Vim, and it will never change. Anything you can do, I can do in Vim, it's just more likely that I don't want to. [Check out vWorkbench](https://davidcraddock.net/vworkbench) if you're interested in seeing my Vim dev environment.
