...
- I have finally fixed a problem that had been annoying me for ages - when I post my blog posts to social media, they used to look rubbish - just a static generic blog image showing my face, and no explanation of the content or a post-specific thumbnail. - In order to fix this, I have developed my own 'spinoff' of the Hugo PaperMod theme, called [PaperMod-dpc](https://github.com/wordswords/PaperMod-dpc.git) In it, I have made some improvements, including an 'intelligent' way of handling the social media [opengraph](https://ogp.me/) data, where it will display much better and interesting preview content on social media.
