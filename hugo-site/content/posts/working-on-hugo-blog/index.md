...
- In this customised theme, I have made some improvements and adjustments for my own need, including an 'intelligent' way of handling the social media [opengraph](https://ogp.me/) data, where it will display much better and interesting preview content on social media.
