...
Using Zed, I have heavily refactored vWorkbench in preparation for [dockerizing](https://docker.io) it for test purposes.
...
If you haven't already, [check it out](https://davidcraddock.net/vWorkbench) - vWorkbench is my customised combination of VIM9 editor plus ZSH shell plus a million other customisations. It currently runs only on [Almalinux](https://almalinux.org/), but will run on 'bare metal' Almalinux as well as Windows 11 WSL2.
